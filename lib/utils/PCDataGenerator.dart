...
List<PCDashboardModel> CricketDashboardList() {
  ...
  var title7 = PCDashboardModel(Cricket_ic_History, Cricket_lbl_Prediction);
  list.add(title7);

  var title8 = PCDashboardModel(Cricket_ic_History, Cricket_lbl_TeamPrediction);
  list.add(title8);

  var title9 = PCDashboardModel(Cricket_ic_History, Cricket_lbl_PlayerPrediction);
  list.add(title9);
  
  var title10 = PCDashboardModel(Cricket_ic_History, Cricket_lbl_Feedback);
  list.add(title10);
